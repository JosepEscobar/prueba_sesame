...
class GuardrailAgent(BaseAgent):
    ...
    def _check_explicitly_excluded(self, query: str) -> Optional[str]:
        """
    ...
    def _create_out_of_scope_response(self, specific_message: Optional[str] = None, reasoning: str = "") -> Dict[str, Any]:
        """
