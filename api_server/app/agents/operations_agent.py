...
class OperationsAgent(BaseAgent):
    ...
    def _execute_impl(self, input_data: dict[str, Any]) -> dict[str, Any]:
        ...
        prompt_builder = AIPromptBuilder(
            role="especialista en operaciones y gestión operativa",
            task="Analiza la consulta y proporciona recomendaciones estratégicas operativas",
            input_data=f"CONSULTA: {query}\n\nCONTEXTO ADICIONAL: {content}",
            context="""Considera estos aspectos en tu análisis:
            ...
            format_hint="""Tu respuesta debe ser práctica y orientada a resultados, incluyendo:
            ...
            criteria="Utiliza terminología precisa de gestión de operaciones, referencias a mejores prácticas y metodologías estándar del sector.",
        )
